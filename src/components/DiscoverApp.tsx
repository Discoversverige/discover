    ...
    <div className="home">
      ...
      <section className="partners">
        ...
        <div className="partners-row">
          <img src="/logos/uber.svg" alt="Uber" className="logo-img" style={{height: "38px"}} />
          <img src="/logos/bolt.png" alt="Bolt" className="logo-img" style={{height: "38px"}} />
          <img src="/logos/airbnb.png" alt="Airbnb" className="logo-img" style={{height: "38px"}} />
          <img src="/logos/revolut.svg" alt="Revolut" className="logo-img" style={{height: "38px"}} />
          <img src="/logos/sj.png" alt="SJ" className="logo-img" style={{height: "38px"}} />
          <img src="/logos/bus4u.png" alt="Bus4u" className="logo-img" style={{height: "38px"}} />
        </div>
      </section>
    </div>
  );
